  ...
  Future<int> saveImage(
    ...
    if (objFile == null) {
      request.files.add(new http.MultipartFile(
          "image_path", PlattobjFile.readStream, PlattobjFile.size,
          filename: PlattobjFile.name));
    } else {
      request.files.add(
        new http.MultipartFile.fromBytes('image_path', objFile,
            filename: 'dummy.png'),
      );
    }
...
/*
  ...
  uploadFileToServer(String email, String mobile, String type, String imageName,
