...
class _DocumentScreenLargeState extends State<DocumentScreenLarge> {
    ...
    switch (id) {
      case 101:
        ...
        openChoiceBottomsheetImagePicker(id, 'pancard', proofType,
            docObj.uniqueId, ['png', 'jpeg', 'PNG', 'JPEG', 'jpg', 'JPG']);
        break;
      case 102:
        print(' Signature :$id');
      ...
      case 103:
        print('Bank Proof :$id');
        openChoiceBottomsheetImagePicker(
            id, 'bankproof', proofType, docObj.uniqueId, ['pdf', 'PDF']);
        break;
      case 104:
      ...
      case 105:
        ...
        openChoiceBottomsheetImagePicker(
            id, 'incomeproof', proofType, docObj.uniqueId, ['pdf', 'PDF']);
        break;
      case 106:
        print('Photograph :$id');
  ...
  void openChoiceBottomsheetImagePicker(int id, String docType,
      String proofType, String uniqueId, List<String> allowedExtension) {
      ...
      if (docType.toString() == "bankproof" ||
        ...
        if (objFile.name.contains('.pdf') || objFile.name.contains('.PDF')) {
          if (sizeInMb > 2) {
            ...
            AppConfig().dismissLoaderDialog(context); //
            documentBloc.saveDocument(context, docType, "large", objFile,
        ...
        if (docType.toString() == "pancard" ||
          ...
          if (objFile.name.contains('.png') ||
            ...
            documentBloc.showAlert(context,
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items:
                            documentBloc.addressProofList.map((String value) {
                          return DropdownMenuItem(
                            value: value,
                            child: Text(
                              value,
                ...
                onPressed: () {
                  if (documentBloc.docPan &&
                    ...
                    HomeScreenLarge.screensStreamLarge.sink
                        .add(Ekycscreenamelarge.ipvdetailscreen);
                  } else {
  ...
  _saveImage(String docType) async {
    ...
    if (result != null) {
      ...
      request.files.add(new http.MultipartFile(
          "image_path", objFile.readStream, objFile.size,
