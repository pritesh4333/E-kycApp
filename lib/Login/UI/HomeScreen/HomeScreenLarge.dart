...
class HomeScreenLarge extends StatefulWidget {
  ...
  static final screensStreamLarge = BehaviorSubject<Ekycscreenamelarge>.seeded(
      Ekycscreenamelarge.pandetailscreen);
...
class HomeScreenLargeState extends State<HomeScreenLarge> {
  ...
  void initState() {
    ...
    if (LoginRepository.firstTimeLogin) {
      ...
      globalRespObj.response.data.message[0].stage =
          LoginRepository.globalCurrentStageTracker;
    }
    if (globalRespObj.response.data.message[0].stage != "") {
      leftMenuSelection =
          int.parse(globalRespObj.response.data.message[0].stage) + 1;
      ...
      HomeScreenLarge.screensStreamLarge.sink
          .add(Ekycscreenamelarge.pandetailscreen);
    }
                              ...
                              return Container(
                                child: Column(
                                  children: [
                                    InkWell(
                                      onTap: () {
                                        if (currentStageTracker >= 1 ||
                                            int.parse(LoginRepository
                                                        .globalCurrentStageTracker) +
                                                    1 >=
                                                1) {
                                          if ((int.parse(LoginRepository
                                                      .globalCurrentStageTracker) +
                                                  1) >
                                              currentStageTracker) {
                                            currentStageTracker = (int.parse(
                                                    LoginRepository
                                                        .globalCurrentStageTracker) +
                                                1);
                                          }
                                          ...
                                          HomeScreenLarge
                                              .screensStreamLarge.sink
                                              .add(Ekycscreenamelarge
                                                  .pandetailscreen);
