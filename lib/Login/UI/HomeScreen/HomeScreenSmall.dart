...
class HomeScreenSmall extends StatefulWidget {
  static final screensStreamSmall = BehaviorSubject<Ekycscreenamesmall>.seeded(
      Ekycscreenamesmall.pandetailscreen);
...
// screen selection as per stage
      ...
      HomeScreenSmall.screensStreamSmall.sink
          .add(Ekycscreenamesmall.pandetailscreen);
    }
                          ...
                          onTap: () {
                            if (currentStageTracker >= 1 ||
                              ...
                              if ((int.parse(LoginRepository
                                      ...
                                      1) >
                                  currentStageTracker) {
                                currentStageTracker = (int.parse(LoginRepository
                                        .globalCurrentStageTracker) +
                                    1);
                              }
                              pandetailclick();
